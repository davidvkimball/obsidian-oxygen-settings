...
export class PresetManager {
  ...
  static generatePresetCSS(preset: CustomColorPreset, mode: 'light' | 'dark'): string {
    ...
    css += `  --base-h: ${palette.base.h};\n`;
    css += `  --base-s: ${palette.base.s}%;\n`;
    css += `  --base-l: ${palette.base.l}%;\n`;
    
    // Required accent HSL variables
    css += `  --accent-h: ${palette.accent.h};\n`;
    css += `  --accent-s: ${palette.accent.s}%;\n`;
    css += `  --accent-l: ${palette.accent.l}%;\n`;
